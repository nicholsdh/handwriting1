...
public class DrawingForest10 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest10() {
        super(10, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
