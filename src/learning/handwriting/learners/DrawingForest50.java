...
public class DrawingForest50 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest50() {
        super(50, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
